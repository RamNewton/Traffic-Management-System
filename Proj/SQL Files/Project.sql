...
delete from vehicle_owner where lpn!="";
delete from vehicle where lpn!="";
delete from vehicle_accident where lpn!="";
delete from accidents where accidentID!="";

select count(*) from license;

select person.firstName,person.lastName,violation.violatorAadhar,count(violation.billid) as countViolation from person,violation group by violatorAadhar having person.aadhar=violation.violatorAadhar;
...
select * from vehicle_owner;
select * from violation;
select * from violation_penalty;person
...
select person.firstname,person.lastname,person.mobNumber,T2.c from person,(select violatorAadhar as VA,count(Billid) as c from violation group by violatorAadhar) as T2 where person.aadhar=T2.VA order by T2.c desc;
